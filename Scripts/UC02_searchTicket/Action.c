...
/*Correlation comment - Do not change!  Original value='133540.523855812ziziQQApzQfiDDDDtVcVDpQttVHf' Name ='userSession' Type ='ResponseBased'*/
	...
	lr_end_transaction("UC02_searchTicket", LR_AUTO);
