Action()
{
	...
	web_submit_data("login.pl", 
		...
		"Mode=HTML", 
		ITEMDATA, 
		"Name=userSession", "Value=133546.305791819zizQciipVAtVzzzHtVcVfpHcizcf", ENDITEM, 
	...
	web_submit_data("reservations.pl_2", 
		...
		"Mode=HTML", 
		ITEMDATA, 
		"Name=outboundFlight", "Value=062;358;03/31/2022", ENDITEM, 
		"Name=numPassengers", "Value=1", ENDITEM, 
		"Name=advanceDiscount", "Value=0", ENDITEM, 
		"Name=seatType", "Value=First", ENDITEM, 
		"Name=seatPref", "Value=Window", ENDITEM, 
	...
	web_submit_data("reservations.pl_3", 
		...
		"Name=address1", "Value=eqweqwe", ENDITEM, 
		"Name=address2", "Value=eweweew", ENDITEM, 
		"Name=pass1", "Value=Jojo Bean", ENDITEM, 
		"Name=creditCard", "Value=132312321", ENDITEM, 
		"Name=expDate", "Value=0323", ENDITEM, 
