...
/*Correlation comment - Do not change!  Original value='133546.221142163zizQciDpHftVcVfpHAcf' Name ='userSession' Type ='ResponseBased'*/
	...
	lr_end_transaction("UC03_viewingItinerary", LR_AUTO);
